...
parser.add_argument('--restore_model_path', type=str, required=False, default='../data/saved_models/output_pretrained/snapshot_epoch_99.pt')
...
args.restore_para_file = '../data/saved_models/{0}_{1}_pretrain_model_dict.pkl'.format(args.per, args.days)
# path to store
args.save_dir = '../data/saved_models/rank_model_per{0}_{1}'.format(args.per, args.days)
# print(args.save_dir)
...
train_multi = pickle.load(open('../data/sym_data/train_multi_perBin_1.pkl', 'rb'))
test_multi = pickle.load(open('../data/sym_data/test_multi_perBin_1.pkl', 'rb'))
...
# data pre-processing
restore_para_file = '../data/saved_models/{0}_{1}_pretrain_model_dict.pkl'.format(args.per, args.days)
