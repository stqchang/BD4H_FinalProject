...
parser.add_argument('--test_neg_num', type=int, default=50)
...
args.restore_para_file = '../data/saved_models/{0}_{1}_pretrain_model_dict.pkl'.format(
    args.per, args.days)
# path to store
args.save_dir = '../data/saved_models/rank_model_per{0}_{1}'.format(
    args.per, args.days)
# print(args.save_dir)
...
# !!!!!!!!!!!!!!!!!!!! we can use create train_multi and test_multi ourselves instead of using nexworkx graph
...
train_multi = pickle.load(
    open('../data/sym_data/train_multi_perBin_1.pkl', 'rb'))
test_multi = pickle.load(
    open('../data/sym_data/test_multi_perBin_1.pkl', 'rb'))
...
if os.path.exists(reuse_oov_path):
    ...
    dev, iv_test, dis_iv_test = pickle.load(open(reuse_oov_path, 'rb'))
else:
...
# data pre-processing
restore_para_file = '../data/saved_models/{0}_{1}_pretrain_model_dict.pkl'.format(
    args.per, args.days)
