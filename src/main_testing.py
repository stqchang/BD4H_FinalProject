...
parser.add_argument("--embed_filename", type=str,
                    default='C:/Users/SuMowll/Documents/Georgia_Tech/CSE6250-Big_Data_Health/Project/Code/data/embeddings/glove.6B.100d.txt')
parser.add_argument('--node_embed_path', type=str,
                    default='C:/Users/SuMowll/Documents/Georgia_Tech/CSE6250-Big_Data_Health/Project/Code/data/embeddings/line2nd_ttcooc_embedding.txt')
parser.add_argument('--ngram_embed_path', type=str,
                    default='C:/Users/SuMowll/Documents/Georgia_Tech/CSE6250-Big_Data_Health/Project/Code/data/embeddings/charNgram.txt')
...
parser.add_argument('--cand_terms_path', type=str,
                    default='', help='your own candidate set')
...
# data pre-processing
args.restore_para_file = 'C:/Users/SuMowll/Documents/Georgia_Tech/CSE6250-Big_Data_Health/Project/Code/data/saved_models/{0}_{1}_pretrain_model_dict.pkl'.format(
    args.per, args.days)
...
if args.cand_terms_path:
    ...
    args.term_strings = pickle.load(open(
        'C:/Users/SuMowll/Documents/Georgia_Tech/CSE6250-Big_Data_Health/Project/Code/data/mappings/term_string_mapping.pkl', 'rb'))
...
while True:
    ...
    print('Searching {} candidate terms by {:.5} seconds\n'.format(
        len(cand_terms), end - start))

    if args.cand_terms_path:
        synonyms = [cand_terms[x] for x in sorted_rank_idx[:args.num_results]]
    else:
        synonyms = [args.term_strings[cand_terms[x]]
                    for x in sorted_rank_idx[:args.num_results]]
